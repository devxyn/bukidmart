...
const TestimonialCards = () => {
  return (
    <div className='w-full md:w-[25rem] border border-[#D9D9D9] bg-shade p-5 md:p-7 rounded-3xl'>
      <p className='text-xl font-light italic tracking-wide mb-5 md:mb-10'>
      ...
      <div className='flex w-full gap-4 items-center'>
        <img className='w-1/5 rounded-full' src={shiela} alt='shiela' />
